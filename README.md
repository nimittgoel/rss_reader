...
RSS reader takes in a URL provided from the RSS feed provider. The data here is in XML format, which is parsed and required data is processed and collected.<br>
...
The data is stored in the constructed classes , and printed .<br>
